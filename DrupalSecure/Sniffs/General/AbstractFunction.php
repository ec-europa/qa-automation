 ...
 * @link     http://pear.php.net/package/PHP_CodeSniffer
 */
abstract class DrupalSecure_Sniffs_General_AbstractFunction implements PHP_CodeSniffer_Sniff
{
    ...
    public function register()
    {
        ...
        DrupalSecure_Sniffs_General_HelperSniff::registerFunctionListener($this);
        return array();
     ...
     * @return void
     */
    public abstract function processFunctionCall(DrupalSecure_Sniffs_General_HelperSniff $sniff, $stackPtr);
