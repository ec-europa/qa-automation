...
/**
 * Detect unsanitized input sent to drupal_set_message().
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 */
class DrupalSecure_Sniffs_XSS_DrupalSetMessageSniff extends DrupalSecure_Sniffs_General_AbstractFunction
{
    /**
