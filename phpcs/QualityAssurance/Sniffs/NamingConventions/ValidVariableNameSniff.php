<?php
/**
 * \QualityAssurance\Sniffs\NamingConventions\ValidVariableNameSniff.
 *
 * @category PHP
...
class ValidVariableNameSniff extends AbstractVariableSniff
{
    ...
    protected function processMemberVar(File $phpcsFile, $stackPtr)
    {
        ...
        if (empty($tokens[$stackPtr]['conditions']) === false) {
            ...
            // For example, see \QualityAssurance\Core\Field\Annotation\FieldFormatter.
            // The only class named "Plugin" in Drupal core is
            // \QualityAssurance\Component\Annotation\Plugin while many Views plugins
            // extend \QualityAssurance\views\Annotation\ViewsPluginAnnotationBase.
