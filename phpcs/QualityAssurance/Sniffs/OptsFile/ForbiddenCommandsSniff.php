<?php
/**
 * \QualityAssurance\Sniffs\OptsFile\ForbiddenCommandsSniff.
 *
 * @category PHP
...
namespace QualityAssurance\Sniffs\OptsFile;
 ...
 * \QualityAssurance\Sniffs\OptsFile\ForbiddenCommandsSniff.
 *
 * Checks the forbidden properties in .opts.yml file.
 *
 * @category PHP
 * @package  PHP_CodeSniffer
 * @link     http://pear.php.net/package/PHP_CodeSniffer
 */
class ForbiddenCommandsSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (preg_match('/\.opts\.yml$/', $phpcsFile->getFilename()) === 1) {
