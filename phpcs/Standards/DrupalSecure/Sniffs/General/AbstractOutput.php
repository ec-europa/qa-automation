<?php
/**
 * DrupalSecure_Sniffs_General_AbstractHelper.
 *
 * PHP version 5
 *
 * @category PHP
 ...
 * @link     http://pear.php.net/package/PHP_CodeSniffer
 */
abstract class DrupalSecure_Sniffs_General_AbstractOutput implements PHP_CodeSniffer_Sniff
{
    ...
    public function register()
    {
        ...
        DrupalSecure_Sniffs_General_HelperSniff::registerOutputListener($this);
        return array();
     ...
     * @return void
     */
    public abstract function processOutput(DrupalSecure_Sniffs_General_HelperSniff $sniff, $stackPtr);
