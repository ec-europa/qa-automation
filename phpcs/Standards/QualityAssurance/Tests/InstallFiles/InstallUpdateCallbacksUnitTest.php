...
class QualityAssurance_Sniffs_InstallFiles_InstallUpdateCallbacks_InstallUpdateCallbacksNUnitTest extends CoderSniffUnitTest
{
  ...
  public function getErrorList($testFile)
  {
    ...
    return (strpos($testFile, 'Error') === false) ? [] : [12 => 1];
  ...
  public function getWarningList($testFile)
  {
    ...
    return (strpos($testFile, 'Warning') === false) ? [] : [12 => 1];
  ...
  public function getTestFiles() {
    return array(
      'error/InstallUpdateCallbacksWarning.install' => '',
    );
  }// end getTestFiles()
